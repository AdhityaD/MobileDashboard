 ...
 * on 07/04/19 | 01:26
 */
class DoctorAdapter(private var data: MutableList<User>, private var friends: HashSet<String>, private val context: Context, private val listener: DoctorAdapterInterface) : RecyclerView.Adapter<DoctorAdapter.ViewHolder>() {

	class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
		val image: ImageView = itemView.imageDoctor
	...
	override fun onBindViewHolder(holder: ViewHolder, position: Int) {
		...
		Utils().imageTopRound(holder.image, user.photoUrl, context)
